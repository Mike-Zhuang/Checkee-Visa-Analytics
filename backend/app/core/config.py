...
APP_VERSION = _env_str("CHECKEE_APP_VERSION", "0.5.6")
...
DETAIL_FETCH_SAMPLE_RATIO = min(1.0, _env_float("CHECKEE_DETAIL_FETCH_SAMPLE_RATIO", 1.0, minimum=0.0))
DETAIL_FETCH_REQUIRE_NOTE = _env_bool("CHECKEE_DETAIL_FETCH_REQUIRE_NOTE", True)
DETAIL_FETCH_SYNC_ON_REFRESH = _env_bool("CHECKEE_DETAIL_FETCH_SYNC_ON_REFRESH", False)
...
REFRESH_REQUIRE_ADMIN_KEY = _env_bool("CHECKEE_REFRESH_REQUIRE_ADMIN_KEY", False)
